...
class MillReportAdmin(admin.ModelAdmin):
    list_display = ('date', 'line', 'cane_weight', 'trash', 'target_crushing', 'reduced_capacity_hours', 'first_mill_extraction', 'reduced_pol_extraction', 'cane_preparation_index', 'purity_drop', 'bagasse_moisture', 'pol_bagasse', 'imbibition_cane', 'imbibition_fiber', 'loss_bagasse', 'downtime', 'created_at' )
